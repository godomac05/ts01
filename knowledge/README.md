...
- `52-pedimentos-aduanales.md`: estructura del número de pedimento (año,
  aduana, patente, folio) y cómo el bot valida su formato automáticamente
  (ver `src/pedimentos/`) — sin confirmar su existencia real ante el SAT.
